<div class="row">
    <div class="col-4">
        @if ($user->avatar)
            <img src="{{Auth::user()->avatar}}" alt="{{ $user->name }}" class="img-thumbnail rounded-circle d-block mx-auto avatar-lg " style="width:150px; border-radius:150%; object-fit:cover;">
        @else
            <i class="fa-solid fa-circle-user text-secondary d-block text-center icon-lg" width="200"></i>
        @endif
    </div>
    <div class="col-8">
        <div class="row mb-3">
