            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        {{-- Search bar here. Show it when the user is login --}}
                        @auth
                            @if (!request()->is('admin/*'))
            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    {{-- 
                        ...
                        instagram.com/post/3/show      No
                        instagram.com/admin/users      Yes
                        instagram.com/admin/5/update   Yes
                        instagram.com/admin/2/destroy  Yes
